...
This project is a Groovy command-line application that demonstrates use of the
JLine 3 library. The project is built using a recent stable version of Gradle.
